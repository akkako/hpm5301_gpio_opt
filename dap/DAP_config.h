...
{
    uint32_t sta = gpio_read_pin(PIN_GPIO, GPIO_GET_PORT_INDEX(PIN_TCK_SLV), GPIO_GET_PIN_INDEX(PIN_TCK_SLV));
    return sta;
}
...
{
    gpio_write_pin(PIN_GPIO, GPIO_GET_PORT_INDEX(PIN_TCK_SLV), GPIO_GET_PIN_INDEX(PIN_TCK_SLV), true);
    // PIN_GPIO->DO[1].SET = 1 << 11;
...
{
    gpio_write_pin(PIN_GPIO, GPIO_GET_PORT_INDEX(PIN_TCK_SLV), GPIO_GET_PIN_INDEX(PIN_TCK_SLV), false);
    // PIN_GPIO->DO[1].CLEAR = 1 << 11;
    // __asm volatile("fence io, io");
}
